...
export const SHIP_THRUST = 0.18;               // px/tick^2 acceleration
export const SHIP_DRAG = 0.99;                 // velocity retained per tick
export const SHIP_MAX_SPEED = 7;               // px/tick
...
export const BULLET_LIFE_TICKS = 60;   // ~1 s of travel, then it fades
...
export const SAUCER = {
  ...
  small: { radius: 11, score: 1000, speed: 2.4, fireInterval: 55, aimError: 0.10 },
};
